 ...
 */
#define NRP_NEST_PYTHON_MODULE NRPNestPythonModule

/*!
 * \brief Name of python module (as string)
 */
#define NRP_NEST_PYTHON_MODULE_STR "NRPNestPythonModule"

/*!
 * \brief Name of NRP Nest Executable
 */
#define NRP_NEST_EXECUTABLE_PATH "/usr/local/nrp/bin/NRPNestExecutable"

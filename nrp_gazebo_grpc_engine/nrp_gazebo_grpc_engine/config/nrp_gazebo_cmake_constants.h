#ifndef NRP_GAZEBO_CMAKE_CONSTANTS_H
#define NRP_GAZEBO_CMAKE_CONSTANTS_H

/* Automatically created by cmake configure file from nrp_gazebo_json_engine/config_headers/nrp_cmake_constants.h.in
 ...
 */
#define GAZEBO_PYTHON_MODULE_NAME NRPGazeboGrpcEnginePython

/*!
 * \brief Name of python module library as string
 */
#define GAZEBO_PYTHON_MODULE_NAME_STR "NRPGazeboGrpcEnginePython"
 ...
 */
#define NRP_GAZEBO_COMMUNICATION_PLUGIN "NRPGazeboGrpcCommunicationPlugin.so"
 ...
 */
#define DEFAULT_GAZEBO_MODEL_DIR "/usr/share/gazebo-11/models"
